...
Push `Practex.html` to whichever static host you picked (Vercel/Netlify/GitHub Pages —
all support literally dragging a file into their dashboard, no build config needed).
Once it's live at your `https://` URL, that's the URL you should have used in step 6.
